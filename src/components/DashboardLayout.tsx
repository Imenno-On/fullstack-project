...
export function DashboardLayout({ children, currentPage, onNavigate, onCreateTest }: DashboardLayoutProps) {
  return (
        ...
        <div className="p-4 border-t">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium truncate">Иван Петров</p>
              <p className="text-sm text-muted-foreground truncate">teacher@edu.ru</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        <header className="bg-white border-b px-8 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              ...
              {currentPage === "students" && "Список учеников и их результаты"}
              {currentPage === "groups" && "Организуйте учеников в группы"}
              {currentPage === "statistics" && "Анализ успеваемости и прогресса"}
            </p>
          </div>
